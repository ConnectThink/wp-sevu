 ...
 * Description: Switches the "Discourage search engines from indexing this site" option on or off based on current URL.  This is useful for making sure that your development site is hidden from search engines, while your live site is not.
 * Version: 1.0.0
...
function sevu_settings_api_init() {
    ...
    register_setting( 'reading', 'sevu_setting_url' );
...
function sevu_setting_section_callback_function() {
    echo '<p>Set your live site URL below. The plugin will compare this to the current URL. If it matches, the "Discourage search engines from indexing this site" setting will be disabled. Otherwise, it will be enabled.</p>';
}
...
// ------------------------------------------------------------------
//
// Creates an input box for our URL setting
//

function sevu_setting_callback_function() {
    echo '<input name="sevu_setting_url" id="sevu_setting_url" type="text" value="'.get_option( 'sevu_setting_url' ).'" />';
}

// ------------------------------------------------------------------
// Enable or Disable privacy mode based on URL option
// ------------------------------------------------------------------
//

function sevu_privacy() {
    $live_url = get_option( 'sevu_setting_url' );
